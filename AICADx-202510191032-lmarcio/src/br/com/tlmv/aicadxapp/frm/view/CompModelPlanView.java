...
//Private
    ...
    protected void drawEntities(ICadViewBase v, double dist, GeomPoint2d ptBase2dMcs, GeomPoint2d pt2dMcs, boolean bDragMode, Graphics g) 
    {
        ...
        for(int i = 0; i < size; i++) {
			...
			oEnt.showTooltip2d(v, pt2dMcs, sclFact, g);
        }
    }
...
//Public
	...
	public void paint(Graphics g) 
	{
    	...
    	this.drawEntities(this.v, dist, ptBase2dMcs, pt2dMcs, bDragMode, g);
		this.drawProps(this.v, dist, ptBase2dMcs, pt2dMcs, bDragMode, g);
		this.drawGrid(this.v, g);
		this.drawCoordsys(this.v, g);
	...
	public void actionKeyResultListener(ResultEvent e) 
	{
		...
		else if(eventType == AppDefs.EVENTTYPE_SCLCHANGE) {
