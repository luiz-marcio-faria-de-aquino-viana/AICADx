...
//Public
	...
	public int createToolbarMenu(JPanel mnuToolbar, ActionListener listener) 
	{
		...
		try {
			...
			//MENU: FILE
			//
			JButton btnStop = FormControlUtil.newImageButton(frm, AppDefs.ICOMNU_FILE_STOP, AppDefs.ACTION_FILE_STOP, 16, 15, true, listener, AppDefs.TOOLTIP_ICOMNU_FILE_STOP);
