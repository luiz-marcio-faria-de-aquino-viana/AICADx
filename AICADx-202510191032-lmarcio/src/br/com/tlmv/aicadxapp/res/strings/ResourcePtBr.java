...
//Public
	...
	public void init()
	{
		...
		map.put(R.TIT_OPENSAVEDATABASEFRAME, "Abrir e Gravar Arquivo de Dados");
		...
		//
		map.put(R.ERR_VALOR_COEFMANNING_DEVE_SER_SUPERIOR, "Valor do coeficiente de manning deve ser superior a %s."); 
		map.put(R.ERR_PERIODO_RECORRENCIA_DEVE_SER_SUPERIOR, "Periodo de recorrencia deve ser igual ou superior a 1."); 
		map.put(R.ERR_VALOR_ESCALA_DEVE_SER_SUPERIOR, "Valor da escala deve ser superior a 1:1."); 
		map.put(R.ERR_VALOR_LARGURA_PAPEL_DEVE_SER_SUPERIOR, "Valor da largura do papel deve ser superior a 1 mm."); 
		map.put(R.ERR_VALOR_ALTURA_PAPEL_DEVE_SER_SUPERIOR, "Valor da altura do papel deve ser superior a 1 mm."); 
