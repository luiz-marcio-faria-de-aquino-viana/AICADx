...
public class CmdZoomToCenter extends CmdBase
{
//Public

	public CmdZoomToCenter() {
		super(AppDefs.ACTION_ZOOM_ZOOMTOCENTER, false, false);
	}
	...
	public InputParamVO promptInputParam(MainFrame frm, InputParamVO oParam)
	{
		...
		PromptUtil.prompt("Zoom to center...");
