...
public class CmdOrthoOnOff extends CmdBase
{
//Public

	public CmdOrthoOnOff() {
		super(AppDefs.ACTION_SETTINGS_ORTHOONOFF, false, false);
	}
	...
	public void doCommand() 
	{
		...
		int orthomode = (v.getOrthomode() == AppDefs.ORTHOMODE_ON) ? AppDefs.ORTHOMODE_OFF : AppDefs.ORTHOMODE_ON;
