...
public class CmdPdfReader extends CmdBase
{
//Private
	...
	private void init() {
		...
		//HELP - VIDEO_TUTORIAL
		//
		this.map.put(AppDefs.ACTION_HELP_COMANDOSBASICOS, AppDefs.HLP_PDFREADER_COMANDOSBASICOS);
		
	}
	
//Public
	
	public CmdPdfReader(String actionCommand) {
	...
	public void doCommand() {
		...
		try {
			...
			String strWorkDir = ctx.getDocsDir();
			String strExternalCommand = AppDefs.RUN_PDFREADER;
	...
	public String getVideo(String actionCommand) {
		String strResult = AppDefs.HLP_PDFREADER_COMANDOSBASICOS;
