...
//Public
    ...
    public CadCone3d(CadBlockDef oBlkDef, CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_CONE3D, oBlkDef, oLayer);
    }
	...
	private void init(CadCone3d other) {
	...
	public static CadCone3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint2d ptCenter, double radius, double altura) {
    	CadCone3d o = new CadCone3d(oBlkDef, oLayer);
    	o.init(ptCenter, radius, altura);
    	return o;
    }
	
	public static CadCone3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint3d ptCenter, double radius, double altura) {
		CadCone3d o = new CadCone3d(oBlkDef, oLayer);
    	o.init(ptCenter, radius, altura);
    	return o;
    }
	
	public static CadCone3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, double xCenter, double yCenter, double zCenter, double radius, double altura) {
    	CadCone3d o = new CadCone3d(oBlkDef, oLayer);
	...
	public static CadCone3d create(CadCone3d other) {
    	CadCone3d o = new CadCone3d(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
