...
//Public
    ...
    public CadPoint(CadBlockDef oBlkDef, CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_POINT, oBlkDef, oLayer);
    }
	...
	public static CadPoint create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint2d pt) {
    	CadPoint o = new CadPoint(oBlkDef, oLayer);
    	o.init(pt);
    	return o;
    }
	
	public static CadPoint create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint3d pt) {
    	CadPoint o = new CadPoint(oBlkDef, oLayer);
    	o.init(pt);
    	return o;
    }

	public static CadPoint create(CadBlockDef oBlkDef, CadLayerDef oLayer, double x, double y, double z) {
    	CadPoint o = new CadPoint(oBlkDef, oLayer);
    	o.init(x, y, z);
    	return o;
    }
	...
	public static CadPoint create(CadPoint other) {
		CadPoint o = new CadPoint(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
