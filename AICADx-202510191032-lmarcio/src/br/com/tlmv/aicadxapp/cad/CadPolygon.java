...
//Public
    ...
    public CadPolygon(CadBlockDef oBlkDef, CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_POLYGON, oBlkDef, oLayer);
    }
	...
	public static CadPolygon create(CadBlockDef oBlkDef, CadLayerDef oLayer) {
		CadPolygon o = new CadPolygon(oBlkDef, oLayer);
    	return o;
    }
	
	public static CadPolygon create(CadBlockDef oBlkDef, CadLayerDef oLayer, double altura, ArrayList<GeomPoint2d> lsPts2d) {
    	CadPolygon o = new CadPolygon(oBlkDef, oLayer);
    	o.init(altura, lsPts2d);
    	return o;
    }
	
	public static CadPolygon create(CadBlockDef oBlkDef, CadLayerDef oLayer, ArrayList<GeomPoint3d> lsPts3d) {
    	CadPolygon o = new CadPolygon(oBlkDef, oLayer);
    	o.init(lsPts3d);
    	return o;
    }
	...
	public static CadPolygon create(CadPolygon other) {
    	CadPolygon o = new CadPolygon(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
	...
	public void save(AppDatabase db, String schemaName, CadDocumentDef doc)
	{
		...
		for(int i = 0; i < szLsPts; i++) {
			...
			CadPolygonPointRecord ptRec = new CadPolygonPointRecord(this.getObjectId(), oPt);
