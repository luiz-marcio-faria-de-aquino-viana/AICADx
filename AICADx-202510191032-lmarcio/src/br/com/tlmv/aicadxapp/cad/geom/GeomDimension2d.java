...
//Public
		...
		GeomPoint3d ptF)
	{
		...
		GeomPoint2d ptF2d = new GeomPoint2d(ptF);
		...
		double h)
	{
		...
		this.init(ptCentroid2d, w, h);
	}

	public GeomDimension2d(GeomDimension2d other)
	{
		this.init(other);
	}
	...
	public void init(GeomDimension2d other)
	{
		this.ptCentroid = new GeomPoint2d(other.ptCentroid);
		double xCentroid = other.ptCentroid.getX();
		double yCentroid = other.ptCentroid.getY();

		this.w = other.w;
		this.h = other.h;
		
		double xMin = xCentroid - other.w / 2.0;
		double yMin = yCentroid - other.h / 2.0;
		this.ptMin = new GeomPoint2d(xMin, yMin);
		
		double xMax = xCentroid + other.w / 2.0;
		double yMax = yCentroid + other.h / 2.0;
		this.ptMax = new GeomPoint2d(xMax, yMax);
