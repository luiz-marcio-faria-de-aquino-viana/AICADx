...
//Public
    ...
    public CadText(CadBlockDef oBlkDef, CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_TEXT, oBlkDef, oLayer);
    }
	...
	public static CadText create(CadBlockDef oBlkDef, CadLayerDef oLayer, String text, GeomPoint2d pt, double height) {
    	CadText o = new CadText(oBlkDef, oLayer);
    	o.init(text, pt, height);
    	return o;
    }
	
	public static CadText create(CadBlockDef oBlkDef, CadLayerDef oLayer, String text, GeomPoint3d pt, double height) {
    	CadText o = new CadText(oBlkDef, oLayer);
    	o.init(text, pt, height);
    	return o;
    }

	public static CadText create(CadBlockDef oBlkDef, CadLayerDef oLayer, String text, double x, double y, double z, double height) {
    	CadText o = new CadText(oBlkDef, oLayer);
	...
	public static CadText create(CadText other) {
		CadText o = new CadText(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
