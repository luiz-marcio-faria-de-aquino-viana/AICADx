...
//Public
    ...
    public CadSphere3d(CadBlockDef oBlkDef, CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_SPHERE3D, oBlkDef, oLayer);
    }
	...
	public static CadSphere3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint2d ptCenter, double radius) {
    	CadSphere3d o = new CadSphere3d(oBlkDef, oLayer);
    	o.init(ptCenter, radius);
    	return o;
    }
	
	public static CadSphere3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint3d ptCenter, double radius) {
		CadSphere3d o = new CadSphere3d(oBlkDef, oLayer);
    	o.init(ptCenter, radius);
    	return o;
    }
	
	public static CadSphere3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, double xCenter, double yCenter, double zCenter, double radius) {
    	CadSphere3d o = new CadSphere3d(oBlkDef, oLayer);
	...
	public static CadSphere3d create(CadSphere3d other) {
    	CadSphere3d o = new CadSphere3d(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
