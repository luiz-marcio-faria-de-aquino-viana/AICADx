...
//Public
    ...
    public CadTorus3d(CadBlockDef oBlkDef, CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_TORUS3D, oBlkDef, oLayer);
    }
	...
	public static CadTorus3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint2d ptCenter, double radius, double torusRadius) {
    	CadTorus3d o = new CadTorus3d(oBlkDef, oLayer);
    	o.init(ptCenter, radius, torusRadius);
    	return o;
    }
	
	public static CadTorus3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint3d ptCenter, double radius, double torusRadius) {
		CadTorus3d o = new CadTorus3d(oBlkDef, oLayer);
    	o.init(ptCenter, radius, torusRadius);
    	return o;
    }
	
	public static CadTorus3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, double xCenter, double yCenter, double zCenter, double radius, double torusRadius) {
    	CadTorus3d o = new CadTorus3d(oBlkDef, oLayer);
	...
	public static CadTorus3d create(CadTorus3d other) {
    	CadTorus3d o = new CadTorus3d(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
