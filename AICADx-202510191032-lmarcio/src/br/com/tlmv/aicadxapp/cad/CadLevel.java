...
//Public
    ...
    public CadLevel(CadBlockDef oBlkDef, CadLayerDef oLayer) {
	...
	private void init(CadLevel otherLine) {
	...
	public static CadLevel create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint2d ptI, GeomPoint2d ptF) {
    	CadLevel o = new CadLevel(oBlkDef, oLayer);
    	o.init(ptI, ptF);
    	return o;
    }
	
	public static CadLevel create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint3d ptI, GeomPoint3d ptF) {
    	CadLevel o = new CadLevel(oBlkDef, oLayer);
    	o.init(ptI, ptF);
    	return o;
    }

	public static CadLevel create(CadBlockDef oBlkDef, CadLayerDef oLayer, double xI, double yI, double zI, double xF, double yF, double zF) {
    	CadLevel o = new CadLevel(oBlkDef, oLayer);
	...
	public static CadLevel create(CadLevel other) {
    	CadLevel o = new CadLevel(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
	...
	{
		CadLevel otherLine = CadLevel.create(this);
	...
	public ArrayList<ItemDataVO> toPropertyList()
	{
		...
		//
		lsProperty.add( new ItemDataVO("Name", this.levelName) );
		lsProperty.add( new ItemDataVO("Text", this.levelText) );
