...
//Public
    ...
    public CadProjectDef(CadBlockDef oBlkDef, CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_PROJECT_DEF, oBlkDef, oLayer);
    }
		...
		GeomVector2d xDir) 
	{
    	...
    	CadProjectDef oEnt = new CadProjectDef(oBlkDef, oLayer);
    	oEnt.init(
    		codigoProjeto,
    		tituloProjeto,
    		descricaoProjeto,
	...
	public static CadProjectDef create(CadProjectDef other) {
		CadProjectDef o = new CadProjectDef(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
