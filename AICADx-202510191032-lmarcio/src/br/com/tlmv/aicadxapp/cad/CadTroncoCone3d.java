...
//Public
    ...
    public CadTroncoCone3d(CadBlockDef oBlkDef, CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_TRONCOCONE3D, oBlkDef, oLayer);
    }
	...
	public static CadTroncoCone3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint2d ptCenter, double baseRadius, double topRadius, double altura) {
    	CadTroncoCone3d o = new CadTroncoCone3d(oBlkDef, oLayer);
    	o.init(ptCenter, baseRadius, topRadius, altura);
    	return o;
    }
	
	public static CadTroncoCone3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, GeomPoint3d ptCenter, double baseRadius, double topRadius, double altura) {
		CadTroncoCone3d o = new CadTroncoCone3d(oBlkDef, oLayer);
    	o.init(ptCenter, baseRadius, topRadius, altura);
    	return o;
    }
	
	public static CadTroncoCone3d create(CadBlockDef oBlkDef, CadLayerDef oLayer, double xCenter, double yCenter, double zCenter, double baseRadius, double topRadius, double altura) {
    	CadTroncoCone3d o = new CadTroncoCone3d(oBlkDef, oLayer);
	...
	public static CadTroncoCone3d create(CadTroncoCone3d other) {
    	CadTroncoCone3d o = new CadTroncoCone3d(other.getBlkDef(), other.getLayer());
    	o.init(other);
    	return o;
    }
