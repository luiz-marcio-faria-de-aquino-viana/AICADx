...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		CadTorus3d oT0 = CadTorus3d.create(currBlockDef, oLayer, oPt3d0, radius, torusRadius);
		currBlockDef.addEntity(oT0);

		torusRadius = 0.25 * Math.random();
		radius = 0.5 * Math.random() + torusRadius;
		CadTorus3d oT1 = CadTorus3d.create(currBlockDef, oLayer, oPt3d1, radius, torusRadius);
		currBlockDef.addEntity(oT1);

		torusRadius = 0.25 * Math.random();
		radius = 0.5 * Math.random() + torusRadius;
		CadTorus3d oT2 = CadTorus3d.create(currBlockDef, oLayer, oPt3d2, radius, torusRadius);
		currBlockDef.addEntity(oT2);

		torusRadius = 0.25 * Math.random();
		radius = 0.5 * Math.random() + torusRadius;
		CadTorus3d oT3 = CadTorus3d.create(currBlockDef, oLayer, oPt3d3, radius, torusRadius);
		currBlockDef.addEntity(oT3);

		torusRadius = 0.25 * Math.random();
		radius = 0.5 * Math.random() + torusRadius;
		CadTorus3d oT4 = CadTorus3d.create(currBlockDef, oLayer, oPt3d4, radius, torusRadius);
		currBlockDef.addEntity(oT4);

		torusRadius = 0.25 * Math.random();
		radius = 0.5 * Math.random() + torusRadius;
		CadTorus3d oT5 = CadTorus3d.create(currBlockDef, oLayer, oPt3d5, radius, torusRadius);
		currBlockDef.addEntity(oT5);

		torusRadius = 0.25 * Math.random();
		radius = 0.5 * Math.random() + torusRadius;
		CadTorus3d oT6 = CadTorus3d.create(currBlockDef, oLayer, oPt3d6, radius, torusRadius);
