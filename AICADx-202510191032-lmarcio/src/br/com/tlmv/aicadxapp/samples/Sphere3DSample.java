...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		CadSphere3d oTC0 = CadSphere3d.create(currBlockDef, oLayer, oPt3d0, radius);
		currBlockDef.addEntity(oTC0);
		
		radius = 1.0 * Math.random();
		CadSphere3d oTC1 = CadSphere3d.create(currBlockDef, oLayer, oPt3d1, radius);
		currBlockDef.addEntity(oTC1);
		
		radius = 1.0 * Math.random();
		CadSphere3d oTC2 = CadSphere3d.create(currBlockDef, oLayer, oPt3d2, radius);
		currBlockDef.addEntity(oTC2);
		
		radius = 1.0 * Math.random();
		CadSphere3d oTC3 = CadSphere3d.create(currBlockDef, oLayer, oPt3d3, radius);
		currBlockDef.addEntity(oTC3);
		
		radius = 1.0 * Math.random();
		CadSphere3d oTC4 = CadSphere3d.create(currBlockDef, oLayer, oPt3d4, radius);
		currBlockDef.addEntity(oTC4);
		
		radius = 1.0 * Math.random();
		CadSphere3d oTC5 = CadSphere3d.create(currBlockDef, oLayer, oPt3d5, radius);
