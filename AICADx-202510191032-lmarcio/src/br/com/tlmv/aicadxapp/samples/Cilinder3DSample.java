...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		CadCilinder3d oCilinder0 = CadCilinder3d.create(currBlockDef, oLayer, oPt3d0, radius, altura);
		currBlockDef.addEntity(oCilinder0);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCilinder3d oCilinder1 = CadCilinder3d.create(currBlockDef, oLayer, oPt3d1, radius, altura);
		currBlockDef.addEntity(oCilinder1);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCilinder3d oCilinder2 = CadCilinder3d.create(currBlockDef, oLayer, oPt3d2, radius, altura);
		currBlockDef.addEntity(oCilinder2);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCilinder3d oCilinder3 = CadCilinder3d.create(currBlockDef, oLayer, oPt3d3, radius, altura);
		currBlockDef.addEntity(oCilinder3);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCilinder3d oCilinder4 = CadCilinder3d.create(currBlockDef, oLayer, oPt3d4, radius, altura);
		currBlockDef.addEntity(oCilinder4);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCilinder3d oCilinder5 = CadCilinder3d.create(currBlockDef, oLayer, oPt3d5, radius, altura);
