...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		//CADRECTANGLE
		//
		CadRectangle oRect0 = CadRectangle.create(currBlockDef, oLayer, oPt3d0, oPt3d1);
		currBlockDef.addEntity(oRect0);
		
		CadRectangle oRect1 = CadRectangle.create(currBlockDef, oLayer, oPt3d1, oPt3d2);
		currBlockDef.addEntity(oRect1);
		
		CadRectangle oRect2 = CadRectangle.create(currBlockDef, oLayer, oPt3d2, oPt3d3);
		currBlockDef.addEntity(oRect2);
		
		CadRectangle oRect3 = CadRectangle.create(currBlockDef, oLayer, oPt3d3, oPt3d4);
		currBlockDef.addEntity(oRect3);
		
		CadRectangle oRect4 = CadRectangle.create(currBlockDef, oLayer, oPt3d4, oPt3d5);
		currBlockDef.addEntity(oRect4);
		
		CadRectangle oRect5 = CadRectangle.create(currBlockDef, oLayer, oPt3d5, oPt3d6);
		...
		CadCircle oCirc0 = CadCircle.create(currBlockDef, oLayer, oPt3d0, radioMax * Math.random());
		currBlockDef.addEntity(oCirc0);
		
		CadCircle oCirc1 = CadCircle.create(currBlockDef, oLayer, oPt3d1, radioMax * Math.random());
		currBlockDef.addEntity(oCirc1);
		
		CadCircle oCirc2 = CadCircle.create(currBlockDef, oLayer, oPt3d2, radioMax * Math.random());
		currBlockDef.addEntity(oCirc2);
		
		CadCircle oCirc3 = CadCircle.create(currBlockDef, oLayer, oPt3d3, radioMax * Math.random());
		currBlockDef.addEntity(oCirc3);
		
		CadCircle oCirc4 = CadCircle.create(currBlockDef, oLayer, oPt3d4, radioMax * Math.random());
		currBlockDef.addEntity(oCirc4);
		
		CadCircle oCirc5 = CadCircle.create(currBlockDef, oLayer, oPt3d5, radioMax * Math.random());
		currBlockDef.addEntity(oCirc5);
		
		CadCircle oCirc6 = CadCircle.create(currBlockDef, oLayer, oPt3d6, radioMax * Math.random());
		...
		CadArc oArc0 = CadArc.create(currBlockDef, oLayer, oPt3d0, oCirc0.getRadius() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc0);
		
		CadArc oArc1 = CadArc.create(currBlockDef, oLayer, oPt3d1, oCirc1.getRadius() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc1);
		
		CadArc oArc2 = CadArc.create(currBlockDef, oLayer, oPt3d2, oCirc2.getRadius() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc2);
		
		CadArc oArc3 = CadArc.create(currBlockDef, oLayer, oPt3d3, oCirc3.getRadius() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc3);
		
		CadArc oArc4 = CadArc.create(currBlockDef, oLayer, oPt3d4, oCirc4.getRadius() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc4);
		
		CadArc oArc5 = CadArc.create(currBlockDef, oLayer, oPt3d5, oCirc5.getRadius() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc5);
		
		CadArc oArc6 = CadArc.create(currBlockDef, oLayer, oPt3d6, oCirc6.getRadius() + radioDiff, 15.0, 75.0);
		...
		CadText oTxt0 = CadText.create(currBlockDef, oLayer, "Ponto 0", oPt3d0, textHeightMax * Math.random());
		currBlockDef.addEntity(oTxt0);
		
		CadText oTxt1 = CadText.create(currBlockDef, oLayer, "Ponto 1", oPt3d1, textHeightMax * Math.random());
		currBlockDef.addEntity(oTxt1);
		
		CadText oTxt2 = CadText.create(currBlockDef, oLayer, "Ponto 2", oPt3d2, textHeightMax * Math.random());
		currBlockDef.addEntity(oTxt2);
		
		CadText oTxt3 = CadText.create(currBlockDef, oLayer, "Ponto 3", oPt3d3, textHeightMax * Math.random());
		currBlockDef.addEntity(oTxt3);
		
		CadText oTxt4 = CadText.create(currBlockDef, oLayer, "Ponto 4", oPt3d4, textHeightMax * Math.random());
		currBlockDef.addEntity(oTxt4);
		
		CadText oTxt5 = CadText.create(currBlockDef, oLayer, "Ponto 5", oPt3d5, textHeightMax * Math.random());
		currBlockDef.addEntity(oTxt5);
		
		CadText oTxt6 = CadText.create(currBlockDef, oLayer, "Ponto 6", oPt3d6, textHeightMax * Math.random());
