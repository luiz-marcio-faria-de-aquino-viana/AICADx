...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		//PIPE
		//
		CadPipe oPipe0 = CadPipe.create(currBlockDef, oLayerTb, oPt3d0, oPt3d1, DrenagemCalc.CAT_TUBULACAO_CONCRETOCLASSEPA1.getDescricao(), 300.0, 30.0);
		currBlockDef.addEntity(oPipe0);
		
		CadPipe oPipe1 = CadPipe.create(currBlockDef, oLayerTb, oPt3d2, oPt3d3, DrenagemCalc.CAT_TUBULACAO_CONCRETOCLASSEPA1.getDescricao(), 300.0, 30.0);
		currBlockDef.addEntity(oPipe1);
		
		CadPipe oPipe2 = CadPipe.create(currBlockDef, oLayerTb, oPt3d4, oPt3d5, DrenagemCalc.CAT_TUBULACAO_CONCRETOCLASSEPA1.getDescricao(), 300.0, 30.0);
		currBlockDef.addEntity(oPipe2);
		
		CadPipe oPipe3 = CadPipe.create(currBlockDef, oLayerTb, oPt3d6, oPt3d7, DrenagemCalc.CAT_TUBULACAO_CONCRETOCLASSEPA1.getDescricao(), 300.0, 30.0);
		currBlockDef.addEntity(oPipe3);
		
		CadPipe oPipe4 = CadPipe.create(currBlockDef, oLayerTb, oPt3d8, oPt3d9, DrenagemCalc.CAT_TUBULACAO_CONCRETOCLASSEPA1.getDescricao(), 300.0, 150.0, 30.0);
		currBlockDef.addEntity(oPipe4);
		
		CadPipe oPipe5 = CadPipe.create(currBlockDef, oLayerTb, oPt3d10, oPt3d11, DrenagemCalc.CAT_TUBULACAO_CONCRETOCLASSEPA1.getDescricao(), 300.0, 150.0, 30.0);
