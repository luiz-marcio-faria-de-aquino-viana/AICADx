...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		//TRECHO_2
		CadCaixaInspecaoDrenagem oCI_A2_1 = CadCaixaInspecaoDrenagem.create(currBlockDef, oLayer, oPt3d_A2_1); 
		dDistAnterior = this.updateData(dDistAnterior, null, oCI_A2_1, "A2.1", 5);
		currBlockDef.addEntity(oCI_A2_1);
		
		CadCaixaInspecaoDrenagem oCI_A2_2 = CadCaixaInspecaoDrenagem.create(currBlockDef, oLayer, oPt3d_A2_2); 
		...
		if(oShape != null) {
			//MODPONTODRENAGEM
			//
			CadPontoDrenagem oRalo_R1 = CadPontoDrenagem.create(currBlockDef, oLayer, oCI_A1, oPt3d_R1, 0.0, oShape, largura, altura, profundidade);
			currBlockDef.addEntity(oRalo_R1);
	
			CadPontoDrenagem oRalo_R2 = CadPontoDrenagem.create(currBlockDef, oLayer, oCI_A1, oPt3d_R2, 0.0, oShape, largura, altura, profundidade);
			currBlockDef.addEntity(oRalo_R2);

			CadPontoDrenagem oRalo_R3 = CadPontoDrenagem.create(currBlockDef, oLayer, oCI_A1, oPt3d_R3, 0.0, oShape, largura, altura, profundidade);
			currBlockDef.addEntity(oRalo_R3);

			CadPontoDrenagem oRalo_R4 = CadPontoDrenagem.create(currBlockDef, oLayer, oCI_A1, oPt3d_R4, 0.0, oShape, largura, altura, profundidade);
			currBlockDef.addEntity(oRalo_R4);
	
			CadPontoDrenagem oRalo_R5 = CadPontoDrenagem.create(currBlockDef, oLayer, oCI_A1, oPt3d_R5, 0.0, oShape, largura, altura, profundidade);
