...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		//CADLINE
		//
		CadLine oLine0 = CadLine.create(currBlockDef, oLayer, oPt3d0, oPt3d1);
		currBlockDef.addEntity(oLine0);

		CadLine oLine1 = CadLine.create(currBlockDef, oLayer, oPt3d1, oPt3d2);
		currBlockDef.addEntity(oLine1);

		CadLine oLine2 = CadLine.create(currBlockDef, oLayer, oPt3d2, oPt3d3);
		currBlockDef.addEntity(oLine2);

		CadLine oLine3 = CadLine.create(currBlockDef, oLayer, oPt3d3, oPt3d4);
		currBlockDef.addEntity(oLine3);

		CadLine oLine4 = CadLine.create(currBlockDef, oLayer, oPt3d4, oPt3d5);
		currBlockDef.addEntity(oLine4);

		CadLine oLine5 = CadLine.create(currBlockDef, oLayer, oPt3d5, oPt3d6);
		currBlockDef.addEntity(oLine5);

		CadLine oLine6 = CadLine.create(currBlockDef, oLayer, oPt3d6, oPt3d0);
		currBlockDef.addEntity(oLine6);
		
		//CADCIRCLE
		//
		CadCircle oCircle0 = CadCircle.create(currBlockDef, oLayer, oPt3d0, 0.25 + (Math.random() * 0.5));
		currBlockDef.addEntity(oCircle0);

		CadCircle oCircle1 = CadCircle.create(currBlockDef, oLayer, oPt3d1, 0.25 + (Math.random() * 0.5));
		currBlockDef.addEntity(oCircle1);

		CadCircle oCircle2 = CadCircle.create(currBlockDef, oLayer, oPt3d2, 0.25 + (Math.random() * 0.5));
		currBlockDef.addEntity(oCircle2);

		CadCircle oCircle3 = CadCircle.create(currBlockDef, oLayer, oPt3d3, 0.25 + (Math.random() * 0.5));
		currBlockDef.addEntity(oCircle3);

		CadCircle oCircle4 = CadCircle.create(currBlockDef, oLayer, oPt3d4, 0.25 + (Math.random() * 0.5));
		currBlockDef.addEntity(oCircle4);

		CadCircle oCircle5 = CadCircle.create(currBlockDef, oLayer, oPt3d5, 0.25 + (Math.random() * 0.5));
		currBlockDef.addEntity(oCircle5);

		CadCircle oCircle6 = CadCircle.create(currBlockDef, oLayer, oPt3d6, 0.25 + (Math.random() * 0.5));
		...
		CadArc oArc0 = CadArc.create(currBlockDef, oLayer, oPt3d0, 0.25 + (Math.random() * 0.5), startAngleDegrees, endAngleDegrees);
		currBlockDef.addEntity(oArc0);

		CadArc oArc1 = CadArc.create(currBlockDef, oLayer, oPt3d1, 0.25 + (Math.random() * 0.5), startAngleDegrees, endAngleDegrees);
		currBlockDef.addEntity(oArc1);

		CadArc oArc2 = CadArc.create(currBlockDef, oLayer, oPt3d2, 0.25 + (Math.random() * 0.5), startAngleDegrees, endAngleDegrees);
		currBlockDef.addEntity(oArc2);

		CadArc oArc3 = CadArc.create(currBlockDef, oLayer, oPt3d3, 0.25 + (Math.random() * 0.5), startAngleDegrees, endAngleDegrees);
		currBlockDef.addEntity(oArc3);

		CadArc oArc4 = CadArc.create(currBlockDef, oLayer, oPt3d4, 0.25 + (Math.random() * 0.5), startAngleDegrees, endAngleDegrees);
		currBlockDef.addEntity(oArc4);

		CadArc oArc5 = CadArc.create(currBlockDef, oLayer, oPt3d5, 0.25 + (Math.random() * 0.5), startAngleDegrees, endAngleDegrees);
		currBlockDef.addEntity(oArc5);

		CadArc oArc6 = CadArc.create(currBlockDef, oLayer, oPt3d6, 0.25 + (Math.random() * 0.5), startAngleDegrees, endAngleDegrees);
