...
public class CmdZoomMoveBackward implements CmdBase, Runnable
{
//Private
	...
	private InputParamVO promptInputParam(MainFrame frm)
	{
		...
		PromptUtil.prompt("Move backward...");
...
//Public
	...
	public void run() {
		...
		cv.zoomMoveForwardBackwardMcs(AppDefs.ZOOM_MOVEBACKWARD);
