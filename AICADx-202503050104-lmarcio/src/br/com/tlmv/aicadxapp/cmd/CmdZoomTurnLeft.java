...
public class CmdZoomTurnLeft implements CmdBase, Runnable
{
//Private
...
//Public
	...
	public void run() {
		...
		cv.zoomTurnLeftRightDegrees(AppDefs.ZOOM_ROTATELEFT);
