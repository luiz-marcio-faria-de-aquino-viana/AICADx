...
public class CmdPDupla implements CmdBase, Runnable
{
//Private
	...
	private InputParamVO promptInputParam(MainFrame frm)
	{
		...
		PromptUtil.prompt("Adding new Double Door...");
		...
		if(oEnt.getObjType() == AppDefs.OBJTYPE_BIMPAREDE) {
			...
			GeomPoint2d ptLocation2d = PromptUtil.getPointAtDir2d(ptI2d, vIF2d, "Set the double door location: ");
