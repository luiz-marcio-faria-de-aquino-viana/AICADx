...
public class CmdZoomMoveForward implements CmdBase, Runnable
{
//Private
	...
	private InputParamVO promptInputParam(MainFrame frm)
	{
		...
		PromptUtil.prompt("Move forward...");
...
//Public
	...
	public void run() {
		...
		cv.zoomMoveForwardBackwardMcs(AppDefs.ZOOM_MOVEFORWARD);
