...
public class CmdZoomTurnRight implements CmdBase, Runnable
{
//Private
...
//Public
	...
	public void run() {
		...
		cv.zoomTurnLeftRightDegrees(AppDefs.ZOOM_ROTATERIGHT);
