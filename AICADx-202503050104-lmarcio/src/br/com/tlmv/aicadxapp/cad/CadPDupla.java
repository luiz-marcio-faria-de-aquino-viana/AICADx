...
//Public
    ...
    public CadPDupla(CadLayerDef oLayer) 
    {
    	super(AppDefs.OBJTYPE_BIMPDUPLA, oLayer);
    }
	...
	public void init(CadPDupla other) 
	{
		this.init(
			other.tipo,
			other.altura,
	...
	public static CadPDupla create(
	    	...
	    	CadAcabamentoPortaDef oAcabamento) 
	{
		CadPDupla other = new CadPDupla(oLayer); 
	...
	{
		CadPDupla o = new CadPDupla(other.getLayer());
		o.init(other);
		return o;
	}
	...
	public CadPDupla scaleTo(GeomPoint3d ptIMcs, GeomPoint3d ptFMcs)
	{
		...
		PrepareDrawUtil prep)
	{
        ...
        //DrawUtil.drawLineProj(v, ptBaseI3dMcs_left, ptElevMid3dMcs_left, g);
        //DrawUtil.drawLineProj(v, ptBaseMid3dMcs_left, ptElevI3dMcs_left, g);
        //
        //DrawUtil.drawLineProj(v, ptBaseMid3dMcs_right, ptElevF3dMcs_right, g);
        //DrawUtil.drawLineProj(v, ptBaseF3dMcs_right, ptElevMid3dMcs_right, g);
        ...
        prep.addFace(v, c2, lsPts3d_extern_left);
        prep.addExternalFace(v, c2, lsPts3d_base_left, lsPts3d_extern_left);
        ...
        prep.addFace(v, c2, lsPts3d_extern_right);
        prep.addExternalFace(v, c2, lsPts3d_base_right, lsPts3d_extern_right);
        ...
        prep.addFace(v, c2, lsPts3d_door_left);
		
        //DOOR_OPPENING - RIGHT
        ArrayList<GeomPoint3d> lsPts3d_door_right = new ArrayList<GeomPoint3d>(); 
        lsPts3d_door_left.add(ptBaseI3dMcs_right);
        lsPts3d_door_left.add(ptBaseF3dMcs_right);
        lsPts3d_door_left.add(ptElevF3dMcs_right);
        lsPts3d_door_left.add(ptElevI3dMcs_right);

        prep.addFace(v, c2, lsPts3d_door_right);
