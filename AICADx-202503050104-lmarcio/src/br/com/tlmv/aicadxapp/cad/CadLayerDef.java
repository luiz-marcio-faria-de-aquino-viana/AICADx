...
//Public
	...
	public CadLayerDef() {
		super(AppDefs.OBJTYPE_LAYER_DEF);
	}
	...
	public int fromStrData(String str)
	{
		...
		String strReference = StringUtil.trimAll(str.substring(36, 51));
		String strLtype = StringUtil.trimAll(str.substring(52, 67));
		String strColor = StringUtil.trimAll(str.substring(68, 83));
		String strLweight = StringUtil.trimAll(str.substring(84));
	...
	public Object[] toArrayData(String strCurrLayer)
	{
		...
		int szArr = AppDefs.HDR_LAYEREXPLORER_TBLLAYERS.length;
