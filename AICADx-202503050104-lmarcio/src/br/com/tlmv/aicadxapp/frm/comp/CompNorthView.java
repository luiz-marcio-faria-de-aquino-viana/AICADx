...
public class CompNorthView extends JPanel implements ICompView, ComponentListener, MouseListener, MouseMotionListener
{
//Private
...
//Public
    ...
    public CompNorthView(MainFrame frm, CadDocumentDef doc) {
		super();
	...
	public void initCadView(double wScr, double hScr)
	{
		...
		//OBSERVER
		GeomPoint3d ptObsMcs = new GeomPoint3d(xCenterMcs, hMcs + 1.0, 1.0);
		GeomPoint3d ptDirMcs = new GeomPoint3d(xCenterMcs, hMcs, 1.0);
