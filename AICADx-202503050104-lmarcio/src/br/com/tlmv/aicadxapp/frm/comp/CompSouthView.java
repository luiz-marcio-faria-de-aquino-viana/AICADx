...
public class CompSouthView extends JPanel implements ICompView, ComponentListener, MouseListener, MouseMotionListener
{
//Private
...
//Public
    ...
    public CompSouthView(MainFrame frm, CadDocumentDef doc) {
		super();
	...
	public void initCadView(double wScr, double hScr)
	{
		...
		//OBSERVER
		GeomPoint3d ptObsMcs = new GeomPoint3d(xCenterMcs, - 1.0, 1.0);
		GeomPoint3d ptDirMcs = new GeomPoint3d(xCenterMcs, 0.0, 1.0);
