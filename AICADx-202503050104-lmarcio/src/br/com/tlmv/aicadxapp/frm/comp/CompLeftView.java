...
public class CompLeftView extends JPanel implements ICompView, ComponentListener, MouseListener, MouseMotionListener
{
//Private
...
//Public
    ...
    public CompLeftView(MainFrame frm, CadDocumentDef doc) {
		super();
	...
	public void initCadView(double wScr, double hScr)
	{
		...
		//OBSERVER
		GeomPoint3d ptObsMcs = new GeomPoint3d(- 1.0, yCenterMcs, 1.0);
		GeomPoint3d ptDirMcs = new GeomPoint3d(0.0, yCenterMcs, 1.0);
