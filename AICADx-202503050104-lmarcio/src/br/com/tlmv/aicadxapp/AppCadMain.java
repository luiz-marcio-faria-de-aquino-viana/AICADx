...
//Public
    ...
    public void initSampleData(int debugLevel)
    {
    	...
    	CadDocumentDef doc = this.documentTable.getDocumentDef(currDocument);
		...
		CadArc oArc0 = CadArc.create(oLayer, oPt3d0, oCirc0.getRadio() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc0);
		
		CadArc oArc1 = CadArc.create(oLayer, oPt3d1, oCirc1.getRadio() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc1);
		
		CadArc oArc2 = CadArc.create(oLayer, oPt3d2, oCirc2.getRadio() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc2);
		
		CadArc oArc3 = CadArc.create(oLayer, oPt3d3, oCirc3.getRadio() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc3);
		
		CadArc oArc4 = CadArc.create(oLayer, oPt3d4, oCirc4.getRadio() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc4);
		
		CadArc oArc5 = CadArc.create(oLayer, oPt3d5, oCirc5.getRadio() + radioDiff, 15.0, 75.0);
		currBlockDef.addEntity(oArc5);
		
		CadArc oArc6 = CadArc.create(oLayer, oPt3d6, oCirc6.getRadio() + radioDiff, 15.0, 75.0);
...
//Public
	...
	public int init() {
		...
		this.initSampleData(AppDefs.DEBUG_LEVEL99);
	...
	{
		CadDocumentDef oCurrDocument = this.documentTable.getDocumentDef(currDocument);
