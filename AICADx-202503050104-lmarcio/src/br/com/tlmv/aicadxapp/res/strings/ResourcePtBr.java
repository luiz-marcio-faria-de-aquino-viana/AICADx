...
public class ResourcePtBr implements R
{
//Public
	...
	/* LIST_VALUES
	 */
	public static final String[] LS_MONTHS_FULLNAME = {
		"Janeiro", "Fevereiro", "Marco", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"	
	};

	public static final String[] LS_MONTHS_ABREV = {
...
//Public
	...
	public void init()
	{
		...
		//ERROS
		map.put("ERR_PROCESSING_FAILURE", "Falha no processamento");
