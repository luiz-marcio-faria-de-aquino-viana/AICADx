...
public class ResourceEnUs implements R
{
//Public
	...
	/* LIST_VALUES
	 */
	private String[] LS_MONTHS_FULLNAME = {
		"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"	
	};

	private String[] LS_MONTHS_ABREV = {
...
//Public
	...
	public void init()
	{
		...
		//COMMAND_PROMPT
		map.put("TXT_COMMAND_PROMPT", "Command");

		//COMMAND_ARC
		map.put("TXT_COMMAND_ARC_PROMPT1", "Center/<Start point>");
		map.put("TXT_COMMAND_ARC_PROMPT2", "Center/End/<Second point>");
		map.put("TXT_COMMAND_ARC_PROMPT3", "End point");
		map.put("TXT_COMMAND_ARC_PROMPT4", "Center");
		map.put("TXT_COMMAND_ARC_PROMPT5", "Start");
		map.put("TXT_COMMAND_ARC_PROMPT6", "Angle/Length of chord/<End point>");
		map.put("TXT_COMMAND_ARC_PROMPT7", "Included angle");
		map.put("TXT_COMMAND_ARC_PROMPT8", "Length of chord");	
		map.put("TXT_COMMAND_ARC_PROMPT9", "Radius");
		map.put("TXT_COMMAND_ARC_PROMPT10", "Direction");

		//COMMAND_LINE
		map.put("TXT_COMMAND_LINE_PROMPT1", "From point");
		map.put("TXT_COMMAND_LINE_PROMPT2", "Close/<To point>"); 
		
		//ERROS
		map.put("ERR_PROCESSING_FAILURE", "Processing failure");
		map.put("ERR_DATA_READ_FAILURE", "Data read failure");
		map.put("ERR_DATA_WRITE_FAILURE", "Data write failure");

		//ALERTAS
		map.put("ALR_PROCESSING_CONCLUDED", "Processing concluded (%s secounds)");
		map.put("ALR_FILE_SAVED", "File saved: %s");
		map.put("ALR_FILE_OPENED", "File opened: %s");
