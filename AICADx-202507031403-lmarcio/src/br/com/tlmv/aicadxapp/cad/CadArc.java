...
//Public
	...
	public static CadArc create(CadLayerDef oLayer, GeomPoint2d ptCenter, double radius, double startAngle, double endAngle) {
    	CadArc o = new CadArc(oLayer);
    	o.init(ptCenter, radius, startAngle, endAngle);
    	return o;
    }
	
	public static CadArc create(CadLayerDef oLayer, GeomPoint3d ptCenter, double radius, double startAngle, double endAngle) {
    	CadArc o = new CadArc(oLayer);
    	o.init(ptCenter, radius, startAngle, endAngle);
    	return o;
    }

	public static CadArc create(CadLayerDef oLayer, double xCenter, double yCenter, double zCenter, double radius, double startAngle, double endAngle) {
    	CadArc o = new CadArc(oLayer);
        ...
        if( bDragMode )
        {
	        ...
	        {        
		        ...
		        else if( AppDefs.ACTION_EDIT2_MIRROR.equals(action) )
		        {
		        	...
		        	ptDestCenter2dMcs = new GeomPoint2d(other.ptCenter);
		        	startAngleRad = GeomUtil.convertDegreesToRad(other.startAngle);
		            endAngleRad = GeomUtil.convertDegreesToRad(other.endAngle);
		        }
	...
	public GeomPoint3d osnap3d(ICadViewBase view2d, int osnapmode, GeomPoint2d pt2dMcs, Graphics g) 
	{
    	...
    	lsPtEndpoint.add( new GeomPoint3d(vStartPoint.getXF(), vStartPoint.getYF(), zp) );
    	lsPtEndpoint.add( new GeomPoint3d(vEndPoint.getXF(), vEndPoint.getYF(), zp) );
    	...
    	lsPtMiddle.add( new GeomPoint3d(vMiddlePoint.getXF(), vMiddlePoint.getYF(), zp) );
