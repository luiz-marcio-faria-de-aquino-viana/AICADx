...
//Public
    ...
    public CadCone3d(CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_CONE3D, oLayer);
    }
	...
	public static CadCone3d create(CadLayerDef oLayer, GeomPoint2d ptCenter, double radius, double altura) {
    	CadCone3d o = new CadCone3d(oLayer);
    	o.init(ptCenter, radius, altura);
    	return o;
    }
	
	public static CadCone3d create(CadLayerDef oLayer, GeomPoint3d ptCenter, double radius, double altura) {
		CadCone3d o = new CadCone3d(oLayer);
    	o.init(ptCenter, radius, altura);
    	return o;
    }
	
	public static CadCone3d create(CadLayerDef oLayer, double xCenter, double yCenter, double zCenter, double radius, double altura) {
    	CadCone3d o = new CadCone3d(oLayer);
	...
	public static CadCone3d create(CadCone3d other) {
    	CadCone3d o = new CadCone3d(other.getLayer());
    	o.init(other);
    	return o;
    }
    ...
    public void redraw2d(ICadViewBase v, double dist, GeomPoint2d ptBase2dMcs, GeomPoint2d pt2dMcs, double sclFact, boolean bDragMode, boolean bSelEnt, Graphics g) 
    {
        ...
        if( bDragMode )
        {
	        ...
	        {        
		        ...
		        {
		        	CadCone3d other = this.duplicate();
