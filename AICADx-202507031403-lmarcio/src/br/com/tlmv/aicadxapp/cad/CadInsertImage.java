...
//Public
    ...
    public CadInsertImage(CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_INSERTIMAGE, oLayer);
    }
	...
	public static CadInsertImage create(CadLayerDef oLayer, String blockName, GeomPoint2d pt, double rotate, double scale) {
		CadInsertImage o = new CadInsertImage(oLayer);
    	o.init(blockName, pt, rotate, scale);
    	return o;
    }
	
	public static CadInsertImage create(CadLayerDef oLayer, String blockName, GeomPoint2d pt, double rotate, double scaleX, double scaleY) {
		CadInsertImage o = new CadInsertImage(oLayer);
		o.init(blockName, pt, rotate, scaleX, scaleY);
		return o;
	}
	
	public static CadInsertImage create(CadLayerDef oLayer, String blockName, GeomPoint3d pt, double rotate, double scale) {
		CadInsertImage o = new CadInsertImage(oLayer);
    	o.init(blockName, pt, rotate, scale);
    	return o;
    }
	
	public static CadInsertImage create(CadLayerDef oLayer, String blockName, GeomPoint3d pt, double rotate, double scaleX, double scaleY) {
		CadInsertImage o = new CadInsertImage(oLayer);
    	o.init(blockName, pt, rotate, scaleX, scaleY);
    	return o;
    }

	public static CadInsertImage create(CadLayerDef oLayer, String blockName, double x, double y, double z, double rotate, double scale) {
		CadInsertImage o = new CadInsertImage(oLayer);
    	o.init(blockName, x, y, z, rotate, scale);
    	return o;
    }

	public static CadInsertImage create(CadLayerDef oLayer, String blockName, double x, double y, double z, double rotate, double scaleX, double scaleY) {
		CadInsertImage o = new CadInsertImage(oLayer);
	...
	public static CadInsertImage create(CadInsertImage other) {
		CadInsertImage o = new CadInsertImage(other.getLayer());
    	o.init(other);
    	return o;
    }
    ...
    public void redraw2d(ICadViewBase v, double dist, GeomPoint2d ptBase2dMcs, GeomPoint2d pt2dMcs, double sclFact, boolean bDragMode, boolean bSelEnt, Graphics g) 
    {
    	...
    	if(oImageDef != null) {
	        ...
	        if(bSelected || bHover) {
	        	...
	        	DrawUtil.drawPointMcs(v, pt2d, AppDefs.POINT_SIZE, g);
	        }
