...
//Public
    ...
    public CadShape(CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_SHAPE, oLayer);
    }
	...
	public static CadShape create(CadLayerDef oLayer, GeomPoint2d pt, double rotate, Shape shape) {
    	CadShape o = new CadShape(oLayer);
    	o.init(pt, rotate, shape);
    	return o;
    }
	
	public static CadShape create(CadLayerDef oLayer, GeomPoint3d pt, double rotate, Shape shape) {
    	CadShape o = new CadShape(oLayer);
    	o.init(pt, rotate, shape);
    	return o;
    }

	public static CadShape create(CadLayerDef oLayer, double x, double y, double z, double rotate, Shape shape) {
    	CadShape o = new CadShape(oLayer);
	...
	public static CadShape create(CadShape other) {
		CadShape o = new CadShape(other.getLayer());
    	o.init(other);
    	return o;
    }
