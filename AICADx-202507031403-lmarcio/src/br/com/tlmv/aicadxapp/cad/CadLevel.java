...
//Public
    ...
    public CadLevel(CadLayerDef oLayer) {
	...
	public static CadLevel create(CadLayerDef oLayer, GeomPoint2d ptI, GeomPoint2d ptF) {
    	CadLevel o = new CadLevel(oLayer);
    	o.init(ptI, ptF);
    	return o;
    }
	
	public static CadLevel create(CadLayerDef oLayer, GeomPoint3d ptI, GeomPoint3d ptF) {
    	CadLevel o = new CadLevel(oLayer);
    	o.init(ptI, ptF);
    	return o;
    }

	public static CadLevel create(CadLayerDef oLayer, double xI, double yI, double zI, double xF, double yF, double zF) {
    	CadLevel o = new CadLevel(oLayer);
    	o.init(xI, yI, zI, xF, yF, zF);
    	return o;
    }
	
	public static CadLevel create(CadLevel otherLine) {
    	CadLevel o = new CadLevel(otherLine.getLayer());
    	o.init(otherLine);
    	return o;
    }
