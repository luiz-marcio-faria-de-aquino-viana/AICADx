...
//Public
    ...
    public CadPolyline(CadLayerDef oLayer) {
    	super(AppDefs.OBJTYPE_POLYLINE, oLayer);
    }
	...
	public static CadPolyline create(CadLayerDef oLayer, double altura, ArrayList<GeomPoint2d> lsPts2d) {
    	CadPolyline o = new CadPolyline(oLayer);
    	o.init(altura, lsPts2d);
    	return o;
    }
	
	public static CadPolyline create(CadLayerDef oLayer, ArrayList<GeomPoint3d> lsPts3d) {
    	CadPolyline o = new CadPolyline(oLayer);
    	o.init(lsPts3d);
    	return o;
    }
	...
	public static CadPolyline create(CadPolyline other) {
    	CadPolyline o = new CadPolyline(other.getLayer());
    	o.init(other);
    	return o;
    }
	...
	public CadPolyline offsetTo(GeomPoint3d ptIMcs, GeomVector3d uDirMcs, double dist)
	{
		...
		CadPolyline oPolygon = copyTo(ptIMcs, ptFMcs);
		return oPolygon;
	}
    ...
    public void redraw2d(ICadViewBase v, double dist, GeomPoint2d ptBase2dMcs, GeomPoint2d pt2dMcs, double sclFact, boolean bDragMode, boolean bSelEnt, Graphics g) 
    {
        ...
        if( bDragMode ) 
        {
	        ...
	        {        
		        ...
		        {
		        	CadPolyline other = this.duplicate();
