...
public abstract class CompView extends JPanel implements ICompView, Printable, ComponentListener, MouseWheelListener, MouseListener, MouseMotionListener, KeyResultListener, Runnable
{
//Private
...
//Public
	...
	public abstract void initCadView(double wScr, double hScr);
	
	public abstract void resetCadView(double wScr, double hScr);
