...
//Public
	...
	public int createToolbarMenu(JPanel mnuToolbar, ActionListener listener) 
	{
		...
		try {
			...
			//JButton btnZoomViewTop = FormControlUtil.newImageButton(MainPanel.getParentFrame(), AppDefs.ICOMNU_ZOOM_VIEWTOP, AppDefs.ACTION_ZOOM_VIEWTOP, 16, 15, true, listener, AppDefs.TOOLTIP_ICOMNU_ZOOM_VIEWTOP);
			//mnuToolbar.add(btnZoomViewTop);

			//JButton btnZoomViewBottom = FormControlUtil.newImageButton(MainPanel.getParentFrame(), AppDefs.ICOMNU_ZOOM_VIEWBOTTOM, AppDefs.ACTION_ZOOM_VIEWBOTTOM, 16, 15, true, listener, AppDefs.TOOLTIP_ICOMNU_ZOOM_VIEWBOTTOM);
			//mnuToolbar.add(btnZoomViewBottom);

			JButton btnZoomViewFront = FormControlUtil.newImageButton(MainPanel.getParentFrame(), AppDefs.ICOMNU_ZOOM_VIEWFRONT, AppDefs.ACTION_ZOOM_VIEWFRONT, 16, 15, true, listener, AppDefs.TOOLTIP_ICOMNU_ZOOM_VIEWFRONT);
			mnuToolbar.add(btnZoomViewFront);

			JButton btnZoomViewBack = FormControlUtil.newImageButton(MainPanel.getParentFrame(), AppDefs.ICOMNU_ZOOM_VIEWBACK, AppDefs.ACTION_ZOOM_VIEWBACK, 16, 15, true, listener, AppDefs.TOOLTIP_ICOMNU_ZOOM_VIEWBACK);
			mnuToolbar.add(btnZoomViewBack);

			JButton btnZoomViewLeft = FormControlUtil.newImageButton(MainPanel.getParentFrame(), AppDefs.ICOMNU_ZOOM_VIEWLEFT, AppDefs.ACTION_ZOOM_VIEWLEFT, 16, 15, true, listener, AppDefs.TOOLTIP_ICOMNU_ZOOM_VIEWLEFT);
			mnuToolbar.add(btnZoomViewLeft);

			JButton btnZoomViewRight = FormControlUtil.newImageButton(MainPanel.getParentFrame(), AppDefs.ICOMNU_ZOOM_VIEWRIGHT, AppDefs.ACTION_ZOOM_VIEWRIGHT, 16, 15, true, listener, AppDefs.TOOLTIP_ICOMNU_ZOOM_VIEWRIGHT);
