...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		CadBox3d oBox0 = CadBox3d.create(oLayer, oPt3d0, oPt3d1, altura);
		currBlockDef.addEntity(oBox0);
		
		altura = 5.0 * Math.random();
		CadBox3d oBox1 = CadBox3d.create(oLayer, oPt3d1, oPt3d2, altura);
		currBlockDef.addEntity(oBox1);
		
		altura = 5.0 * Math.random();
		CadBox3d oBox2 = CadBox3d.create(oLayer, oPt3d2, oPt3d3, altura);
		currBlockDef.addEntity(oBox2);
		
		altura = 5.0 * Math.random();
		CadBox3d oBox3 = CadBox3d.create(oLayer, oPt3d3, oPt3d4, altura);
		currBlockDef.addEntity(oBox3);
		
		altura = 5.0 * Math.random();
		CadBox3d oBox4 = CadBox3d.create(oLayer, oPt3d4, oPt3d5, altura);
		currBlockDef.addEntity(oBox4);
		
		altura = 5.0 * Math.random();
		CadBox3d oBox5 = CadBox3d.create(oLayer, oPt3d5, oPt3d6, altura);
