...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		CadTroncoCone3d oTC0 = CadTroncoCone3d.create(oLayer, oPt3d0, baseRadius, topRadius, altura);
		currBlockDef.addEntity(oTC0);
		
		topRadius = 0.75 * Math.random();
		baseRadius = topRadius + ( 1.0 * Math.random() );
		altura = 5.0 * Math.random();
		CadTroncoCone3d oTC1 = CadTroncoCone3d.create(oLayer, oPt3d1, baseRadius, topRadius, altura);
		currBlockDef.addEntity(oTC1);
		
		topRadius = 0.75 * Math.random();
		baseRadius = topRadius + ( 1.0 * Math.random() );
		altura = 5.0 * Math.random();
		CadTroncoCone3d oTC2 = CadTroncoCone3d.create(oLayer, oPt3d2, baseRadius, topRadius, altura);
		currBlockDef.addEntity(oTC2);
		
		topRadius = 0.75 * Math.random();
		baseRadius = topRadius + ( 1.0 * Math.random() );
		altura = 5.0 * Math.random();
		CadTroncoCone3d oTC3 = CadTroncoCone3d.create(oLayer, oPt3d3, baseRadius, topRadius, altura);
		currBlockDef.addEntity(oTC3);
		
		topRadius = 0.75 * Math.random();
		baseRadius = topRadius + ( 1.0 * Math.random() );
		altura = 5.0 * Math.random();
		CadTroncoCone3d oTC4 = CadTroncoCone3d.create(oLayer, oPt3d4, baseRadius, topRadius, altura);
		currBlockDef.addEntity(oTC4);
		
		topRadius = 0.75 * Math.random();
		baseRadius = topRadius + ( 1.0 * Math.random() );
		altura = 5.0 * Math.random();
		CadTroncoCone3d oTC5 = CadTroncoCone3d.create(oLayer, oPt3d5, baseRadius, topRadius, altura);
