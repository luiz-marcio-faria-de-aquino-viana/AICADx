...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		//MODCAIXAINSPECAO
		//
		CadCaixaInspecaoDrenagem oCI0 = CadCaixaInspecaoDrenagem.create(oLayer, oPt3d0); 
		this.updateData(oCI0, 1, 1, 0.0);
		currBlockDef.addEntity(oCI0);

		CadCaixaInspecaoDrenagem oCI1 = CadCaixaInspecaoDrenagem.create(oLayer, oPt3d1); 
		this.updateData(oCI1, 2, 2, 0.5);
		currBlockDef.addEntity(oCI1);

		CadCaixaInspecaoDrenagem oCI2 = CadCaixaInspecaoDrenagem.create(oLayer, oPt3d2); 
		this.updateData(oCI2, 3, 3, 1.0);
		currBlockDef.addEntity(oCI2);

		CadCaixaInspecaoDrenagem oCI3 = CadCaixaInspecaoDrenagem.create(oLayer, oPt3d3); 
		this.updateData(oCI3, 4, 4, 1.5);
		currBlockDef.addEntity(oCI3);

		CadCaixaInspecaoDrenagem oCI4 = CadCaixaInspecaoDrenagem.create(oLayer, oPt3d4); 
		this.updateData(oCI4, 5, 5, 2.0);
		currBlockDef.addEntity(oCI4);

		CadCaixaInspecaoDrenagem oCI5 = CadCaixaInspecaoDrenagem.create(oLayer, oPt3d5); 
		this.updateData(oCI5, 6, 6, 2.5);
		currBlockDef.addEntity(oCI5);

		CadCaixaInspecaoDrenagem oCI6 = CadCaixaInspecaoDrenagem.create(oLayer, oPt3d6); 
