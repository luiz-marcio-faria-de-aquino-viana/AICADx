...
//Public
    ...
    public void initSampleData(int debugLevel, CadDocumentDef doc)
    {
		...
		CadCone3d oCilinder0 = CadCone3d.create(oLayer, oPt3d0, radius, altura);
		currBlockDef.addEntity(oCilinder0);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCone3d oCilinder1 = CadCone3d.create(oLayer, oPt3d1, radius, altura);
		currBlockDef.addEntity(oCilinder1);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCone3d oCilinder2 = CadCone3d.create(oLayer, oPt3d2, radius, altura);
		currBlockDef.addEntity(oCilinder2);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCone3d oCilinder3 = CadCone3d.create(oLayer, oPt3d3, radius, altura);
		currBlockDef.addEntity(oCilinder3);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCone3d oCilinder4 = CadCone3d.create(oLayer, oPt3d4, radius, altura);
		currBlockDef.addEntity(oCilinder4);
		
		radius = 1.0 * Math.random();
		altura = 5.0 * Math.random();
		CadCone3d oCilinder5 = CadCone3d.create(oLayer, oPt3d5, radius, altura);
