...
//Public
	...
	public int createToolbarMenu(JPanel mnuToolbar, ActionListener listener) 
	{
		...
		try {
			//MENU: TOOLBARINQUIRY
			//
			JButton btnDist = FormControlUtil.newImageButton(MainPanel.getParentFrame(), AppDefs.ICOMNU_INQUIRY_DISTANCE, AppDefs.ACTION_INQUIRY_DIST, 16, 15, true, listener, AppDefs.TOOLTIP_ICOMNU_INQUIRY_DISTANCE);
