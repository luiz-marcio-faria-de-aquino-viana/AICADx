...
//Public
	...
	{
		int x = (int)( ((double)w_parent / 2.0) - ((double)AppDefs.MESSAGE_FRAME_WIDTH / 2.0) );
		int y = (int)( ((double)h_parent / 2.0) - ((double)AppDefs.MESSAGE_FRAME_HEIGHT / 2.0) );
		
		setSize(AppDefs.MESSAGE_FRAME_WIDTH, AppDefs.MESSAGE_FRAME_HEIGHT);
		setLocation(x, y);
